...
//     const newFileSizes = [];
//     const newConvertedModels = [];
//     const simplify = new Simplify(); // Updated instantiation
...
//             const simplificationPercentage = 0.5; // Adjust this value to control the level of simplification
//             child.geometry = simplify.modify(child.geometry, simplificationPercentage);
//           }
//         });
...
//               child.geometry = simplify.modify(child.geometry, simplificationLevel);
//             }
//           }
//         });
...
//           accept=".fbx"
//         />
//         <div className="simplification-buttons">
//           <button onClick={() => handleSimplificationLevel(0)}>Normal</button>
//           <button onClick={() => handleSimplificationLevel(0.95)}>95% Reduction</button>
//           <button onClick={() => handleSimplificationLevel(0.5)}>50% Reduction</button>
//           <button onClick={() => handleSimplificationLevel(0.2)}>20% Reduction</button>
//         </div>
//         <button onClick={processModels}>Process Models</button>
//         <button onClick={saveConvertedModels}>Save Converted Models</button>
//         <div ref={mountRef} style={{ width: "99%", height: "100vh" }}></div>
...
//         <div className="simplification-buttons">
//           <button onClick={() => handleSimplificationLevel(0)}>Normal</button>
//           <button onClick={() => handleSimplificationLevel(0.90)}>90% Reduction</button>
//           <button onClick={() => handleSimplificationLevel(0.45)}>45% Reduction</button>
//           <button onClick={() => handleSimplificationLevel(0.225)}>22.5% Reduction</button>
//         </div>
//         <button onClick={processModels}>Process Models</button>
//         <button onClick={saveConvertedModels}>Save Converted Models</button>
//         <div ref={mountRef} style={{ width: "99%", height: "100vh" }}></div>
